/*here by implementing runnable interface and using thread class we are checking 
 *given number is prime or not 
 */
 package demo;
//Package is a grouping of related types providing access protection and name 
//demo is the package name
//A class uses the implements keyword to implement the interface.It appears in the
//class declaration follwing extends portion of the declaration
